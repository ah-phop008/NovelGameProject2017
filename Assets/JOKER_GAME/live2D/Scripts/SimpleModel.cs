...
public class SimpleModel : MonoBehaviour
{
    ...
    void Json_Read()
    {
		...
		// エラー解決 (NullReferenceEception)
		// jsonFile内、"model"にファイルパスを追加。
		// "haru_01.moc"→"haru/haru_01.moc"
		// ファイル内に記載されてるほかのファイルパスにも”haru/”を追加
		// "model"以外に、"pose.json","phisics.json"の中身も同様
